...
import com.masscustsoft.service.RamTempService;
 ...
 */
public class DiskTempItemFactory implements FileItemFactory {
     ...
     */
    public DiskTempItemFactory(int sizeThreshold, TempService repository) {
     ...
     *
     */
    public TempService getRepository() {
        return repository;
    }
     ...
     *
     */
    public void setRepository(TempService repository) {
        this.repository = repository;
    }
    ...
    /**
     * Create a new {@link org.apache.commons.fileupload.disk.DiskTempItem}
