 ...
 *          bayard $
 */
public class DeferredTempOutputStream extends ThresholdingOutputStream {
	 ...
	 */
	public DeferredTempOutputStream(TempService repository, int threshold) {
		super(threshold);
	...
	protected void thresholdReached() throws IOException {
		outputFile = repository.newTempItem(null);
		OutputStream fos = outputFile.getOutputStream();
		;
	...
	public void writeTo(OutputStream out) throws IOException {
		...
		if (isInMemory()) {
			...
			InputStream fis = outputFile.getInputStream();
			try {
